...
\newcommand{\hsaaLogo}{%
  % Template: looks for a logo file in the working directory. Provide one of
  % the files below or update this macro to point to your logo (e.g.
  % "logo.png"). The macro is intentionally permissive so the template
  % works in different projects without modification.
  \IfFileExists{Hochschule-aalen.svg.png}{%
    ...
    \IfFileExists{hs-aalen-logo.png}{\includegraphics[height=0.9cm]{hs-aalen-logo.png}}{%
      % No default logo found — leave the header blank. To add a logo,
      % place a file named "Hochschule-aalen.svg.png" or
      % "hs-aalen-logo.png" next to this .tex, or change this macro.
    }%
  }%
}
...
% ===============================
% Titelinformationen (Vorlage)
% ===============================
% Ersetze die folgenden Platzhalter durch deine Inhalte. Du kannst die
% Datei direkt anpassen oder diese Vorlage in ein Projekt kopieren und die
...
\date{\today} % oder \date{Month Year}
